...
#=============================
# Salvar banco de dados dos modelos 1 a 4 com variáveis renomeadas
# modelo 1
write.table(analysis_data, "analysis_data.csv", sep = ";", row.names = F)
...
# Modelo de Regressão Linear Multivariado 1
...
#=================
# Modelo de Regressão Multivariado 2

modelo_2 <- lm(`Civil Liberties 1` ~  +
                 `Favoritism in decisions of government officials` + 
                 `Accountability` + 
                 `Institucional Efficiency` + 
                 `Ethnic_linguistic Plurality` , 
...
analysis_data$Residuo <- analysis_data$`Civil Liberties 1` - analysis_data$Preditos
...
analysis_data_2$Residuo <- analysis_data_2$`Civil Liberties 1` - analysis_data_2$Preditos
...
analysis_data_3$Residuo <- analysis_data_3$`Civil Liberties 2` - analysis_data_3$Preditos
...
analysis_data_4$Residuo <- analysis_data_4$`Civil Liberties 2` - analysis_data_4$Preditos
